(self["webpackChunknotice"] = self["webpackChunknotice"] || []).push([[994],{
...
var Connector = __webpack_require__(97153);
...
var EmotionHappy = __webpack_require__(51719);
// EXTERNAL MODULE: ./node_modules/@strapi/icons/dist/EmotionUnhappy.js
var EmotionUnhappy = __webpack_require__(71008);
...
var Exit = __webpack_require__(306);
// EXTERNAL MODULE: ./node_modules/@strapi/icons/dist/Expand.js
var Expand = __webpack_require__(58164);
...
var Feather = __webpack_require__(23593);
...
var FileError = __webpack_require__(88041);
...
var Italic = __webpack_require__(1118);
// EXTERNAL MODULE: ./node_modules/@strapi/icons/dist/Key.js
var Key = __webpack_require__(52565);
...
var Paint = __webpack_require__(14609);
// EXTERNAL MODULE: ./node_modules/@strapi/icons/dist/PaintBrush.js
var PaintBrush = __webpack_require__(84342);
...
var dist_Boolean = __webpack_require__(10695);
...
var BaseButton = __webpack_require__(3086);
...
var More = __webpack_require__(54469);
...
var Loader = __webpack_require__(81487);
...
var FieldAction = __webpack_require__(21776);
...
const InputUID = (0,react.forwardRef)(
  ({
    attribute,
    contentTypeUID,
    hint,
...
var Link_Link = __webpack_require__(28438);
...
var Status = __webpack_require__(21628);
...
var index_esm = __webpack_require__(95582);
...
const RelationInput = ({
  ...
  const fieldRef = (0,helper_plugin_esm/* useFocusInputField */.E2)(name);
...
var NumberList = __webpack_require__(41842);
...
const RepeatableComponent = ({
  ...
  const search = (0,helper_plugin_esm/* useQuery */.aM)();
...
var Dot = __webpack_require__(88093);
...
const EditView = ({ allowedActions, isSingleType, goBack, slug, id, origin, userPermissions }) => {
  ...
  const Information = (0,useEnterprise/* useEnterprise */.c)(
    InformationBoxCE,
    async () => (await __webpack_require__.e(/* import() */ 8107).then(__webpack_require__.bind(__webpack_require__, 56996))).InformationBoxEE
  );
  useOnce(() => {
...
const useAllowedAttributes = (contentType, slug) => {
  ...
  const canReadAdminUsers = (0,helper_plugin_esm/* findMatchingPermissions */.ZT)(allPermissions, [
    {
...
var Loader_Loader = __webpack_require__(59912);
// EXTERNAL MODULE: ./node_modules/@strapi/icons/dist/CrossCircle.js
var CrossCircle = __webpack_require__(60874);
...
var AvatarGroup = __webpack_require__(71924);
...
function ListView({
  ...
  const toggleNotification = (0,helper_plugin_esm/* useNotification */.lm)();
  const { trackUsage } = (0,helper_plugin_esm/* useTracking */.rS)();
  const { allPermissions, refetchPermissions } = (0,helper_plugin_esm/* useRBACProvider */.vn)();
  ...
  const { users, isLoading: isLoadingAdminUsers } = (0,useAdminUsers/* useAdminUsers */.R)(
    { filter: { id: { in: selectedUserIds } } },
    {
      ...
      enabled: selectedUserIds.length > 0 && (0,helper_plugin_esm/* findMatchingPermissions */.ZT)(allPermissions, [
        {
          action: "admin::users.read",
          subject: null
        }
        ...
        return [
          ...
          ...eeFilters.filter((eeFilter) => {
            if (eeFilter.name === "strapi_assignee") {
              return (0,helper_plugin_esm/* findMatchingPermissions */.ZT)(allPermissions, [
                {
                  action: "admin::users.read",
                  subject: null
                }
    ...
    data.map((rowData, index) => {
      return /* @__PURE__ */ react.createElement(Tr.Tr, { cursor: "pointer", key: data.id, onClick: handleRowClick(rowData.id) }, /* @__PURE__ */ react.createElement(Body.CheckboxDataCell, { rowId: rowData.id, index }), tableHeaders.map(({ key, name, cellFormatter, ...rest }) => {
        ...
        if (["createdBy", "updatedBy"].includes(name.split(".")[0])) {
          return /* @__PURE__ */ react.createElement(Cell.Td, { key }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "neutral800" }, (0,utils/* getDisplayName */.Gf)(rowData[name.split(".")[0]], formatMessage)));
        }
        if (["createdBy", "updatedBy"].includes(name.split(".")[0])) {
          return /* @__PURE__ */ react.createElement(Cell.Td, { key }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "neutral800" }, (0,utils/* getDisplayName */.Gf)(rowData[name.split(".")[0]], formatMessage)));
        }
...
const Body = () => {
  ...
  const getFieldInfo = (atField, byField) => {
    ...
    const displayName = (0,utils/* getDisplayName */.Gf)(user, formatMessage);
